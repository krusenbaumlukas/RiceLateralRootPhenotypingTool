...
This software can be used to obtain phenotypic data of lateral root traits from rice root scans. Please refer to ./CalibrationImages as reference to what these scans should look like. Using this software the following traits can be measured in a semi-automated manner:
